...
from networks.ADM.attention import SpatialTransformer #SHAHRIAR EDIT
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None, return_emb=False): 
        # SHAHRIAR EDIT: swapped places of x and timesteps from timesteps,x to x,timesteps
        """
        ...
        if timesteps.view(-1, 1).size(0) != x.size(0):
            ...
            timesteps = timesteps * th.ones(x.size(0), device=x.device) # SHAHRIAR EDIT
